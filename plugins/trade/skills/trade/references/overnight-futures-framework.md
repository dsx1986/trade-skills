...
| ~~Massive indices (`I:VIX`, `I:SPX`, `I:NDX`)~~ | **NOT ENTITLED — 403, verified 2026-08-16.** The vol-complex leg has to come from TradingView, or from **VX futures** via `/futures/v1/*` (entitled). For index *level*, use the ETF proxy (SPY / QQQ) and say you used the proxy. |
