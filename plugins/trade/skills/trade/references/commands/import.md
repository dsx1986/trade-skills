...
4. **Write in English** (standing preference — see `SKILL.md` User Profile). Writedowns dated before 2026-07-30 are in Chinese; do not rewrite them, just match the structure. Keep the source's own title, author name, and untranslatable domain terms as-is, glossed on first use.
